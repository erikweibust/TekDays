...
class TekEventSpec extends Specification {
    ...
    void "test toString()"() {
	 	...
	 	when: "a tekEvent has only a name"
			def tekEvent2 = new TekEvent( name:'JavaMUG World' )
	 	then: "the toString method will do what?"
			tekEvent2.toString() == 'JavaMUG World, null'
    }
}
